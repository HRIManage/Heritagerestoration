      ...
      <div className="page-container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="font-sans text-brand-ink text-base md:text-lg font-light leading-relaxed mb-4">
            If you are a victim of a fire or other disaster, restoration can't
            wait. Drag the handle below to reveal our reconstruction
            craftsmanship, moving from devastating loss back to a fully
            restored, premium custom home.
          </p>
          <a
            href="tel:3604561015"
