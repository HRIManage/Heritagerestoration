      ...
      <div className="page-container relative z-10 px-4 md:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-brand-green italic font-normal">Restoring Your Peace</span> of Mind.
          </h1>
          ...
          >
            Professional fire, water &amp; storm damage restoration available 24/7. 
            Locally owned since 2004. Serving Thurston, Lewis, and surrounding counties with integrity.
          </p>
          ...
          >
            {['IICRC Certified', 'Licensed & Bonded', 'Est. 2004', 'Lic. #HERITRI964J2'].map((badge) => (
              <span 
                key={badge} 
