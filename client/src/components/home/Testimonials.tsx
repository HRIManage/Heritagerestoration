...
const testimonials = [
  ...
  {
    stars: 5,
    text: "The storm took out half our roof. Heritage had it tarped and secure within 4 hours, even on a Sunday night. Their professionalism and speed gave us real peace of mind.",
    name: "Derek P.",
