      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-1">
            <Link href="/">
              <img src={LOGO} alt="Heritage Restoration" className="h-[84px] w-auto mb-6 cursor-pointer" />
            </Link>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/heritagerestorationinc/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#3F4143]/8 flex items-center justify-center hover:bg-[#8DBD42] hover:text-white transition-colors"><Facebook size={18} /></a>
              <a href="https://www.instagram.com/heritagerestorationwa/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#3F4143]/8 flex items-center justify-center hover:bg-[#8DBD42] hover:text-white transition-colors"><Instagram size={18} /></a>
            </div>
          </div>

          <div>
            <h4 className="text-[#2f3133] font-black uppercase text-xs tracking-widest mb-6">Services</h4>
            <ul className="space-y-4">
              {serviceItems.map(item => (
                <li key={item.label}>
                  <Link href={item.href} className="text-[#3F4143]/65 hover:text-[#8DBD42] text-sm font-bold transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-[#2f3133] font-black uppercase text-xs tracking-widest mb-6">Resources</h4>
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/contact" className="text-[#3F4143]/65 hover:text-[#8DBD42] text-sm font-bold transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="text-[#2f3133] font-black uppercase text-xs tracking-widest mb-6">Office Locations</h4>
            <ul className="space-y-6 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+13603451015" className="text-[#3F4143]/65 hover:text-[#8DBD42] font-bold transition-colors">(360) 345-1015</a>
              </li>
              <li className="flex items-start gap-3">
                <Mail size={18} className="text-[#8DBD42] flex-shrink-0" />
                <a href="mailto:office@firewaterstorm.com" className="text-[#3F4143]/65 hover:text-[#8DBD42] font-bold transition-colors">office@firewaterstorm.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-[#3F4143]/15 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-[#3F4143]/40 text-[10px] font-black uppercase tracking-widest">
            <Link href="#" className="hover:text-[#3F4143]">Privacy Policy</Link>
            <Link href="#" className="hover:text-[#3F4143]">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
