...
export const BUSINESS_SCHEMA = {
  ...
  "description": "Professional 24/7 fire, water, and storm damage restoration services in Western Washington. IICRC certified, locally owned since 2004. Homeowner advocates handling insurance coordination and complete reconstruction.",
  "telephone": "+1-360-345-1015",
  "email": "office@firewaterstorm.com",
  ...
  "hasOfferCatalog": {
    ...
    "itemListElement": [
      ...
      { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Contents Cleaning & Storage" } }
    ]
  },
