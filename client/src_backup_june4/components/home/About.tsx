      ...
      <div className="page-container">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div ref={leftRef} className="lg:col-span-5" style={{ opacity: 0 }}>
            <span className="overline-label mb-3 text-brand-green">Who We Are</span>
          ...
          <div ref={rightRef} className="lg:col-span-7 space-y-6" style={{ opacity: 0 }}>
            <p className="font-sans text-brand-ink text-base md:text-lg font-light leading-relaxed">
              When disaster strikes your home or business, the path to recovery can feel overwhelming. 
              At Heritage Restoration, we specialize in transforming chaos into absolute clarity. 
              Since 2004, our team of IICRC-certified professionals has guided property owners 
              through the complex process of fire reconstruction, advanced moisture mitigation, and 
              storm damage stabilization.
            </p>
            
            <p className="font-sans text-brand-ink text-base md:text-lg font-light leading-relaxed">
              We operate as your dedicated advocate, working directly with insurance providers to 
              navigate complex claims and ensure your property is restored to its pre-loss state 
              with zero compromise. We don't just rebuild structures; we restore peace of mind.
            </p>
