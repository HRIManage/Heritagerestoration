export default function BottomCTA() {
  const regions = [
    'Lacey', 'Olympia', 'Tumwater', 'Chehalis', 'Centralia', 
    'Yelm', 'Tenino', 'Rochester', 'Thurston County', 'Lewis County'
  ];
    ...
    <>
      ...
      <section className="relative py-24 text-center bg-brand-charcoal text-white overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://picsum.photos/seed/heritageCTA2026/1920/800')" }}
        />
        ...
        <div className="page-container relative z-10 max-w-2xl mx-auto">
          ...
          <p className="font-sans text-brand-linen/75 text-base md:text-lg font-light leading-relaxed mb-10">
            Contact Heritage Restoration for a free professional damage assessment. Our teams are on standby 24 hours a day, 7 days a week, ready to deploy.
          </p>
