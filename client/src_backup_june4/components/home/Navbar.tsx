...
export default function Navbar() {
  ...
  const handleLeave = (idx: number, label: string) => {
    ...
    const el = lineRefs.current[idx]
    if (!el) return
    gsap.to(el, { scaleX: 0, transformOrigin: 'right center', duration: 0.18, ease: 'power2.in' })
  }
  ...
  return (
    <>
      <header
        ref={headerRef}
        style={{ opacity: 0, position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50 }}
        className="w-full"
      >
        {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        <div className="hidden lg:block w-full">
          ...
          >
            ...
            <div style={{ backgroundColor: '#ffffff', height: 140, borderBottom: '1px solid var(--color-brand-stone)' }}>
              <div 
              ...
              >
                ...
                <a href="#hero" onClick={() => setActive('Home')} style={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
                  <img src="/photo/heritage-logo.png" alt="Heritage Restoration" width={520} height={113} style={{ height: 113, width: 'auto' }} />
                </a>
            ...
            <div style={{ backgroundColor: 'var(--color-brand-linen)', height: 48, borderBottom: '1px solid var(--color-brand-stone)' }}>
              <div 
                className="page-container" 
                style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}
              >
          ...
          >
            <div className="page-container" style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <a href="#hero" onClick={() => setActive('Home')} style={{ flexShrink: 0 }}>
                <img src="/photo/heritage-logo.png" alt="Heritage Restoration" width={426} height={90} style={{ height: 90, width: 'auto' }} />
              </a>
                  ...
                  return (
                    <a
                      ...
                      style={{
                        ...
                        color: isActive ? 'var(--color-brand-green)' : 'var(--color-brand-charcoal)',
                        textDecoration: 'none',
        ...
        >
          ...
          >
            ...
            <a href="#hero" onClick={() => { setMobileOpen(false); setActive('Home') }}>
              <img
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              >
                <span style={{ display: 'block', width: 22, height: 2, backgroundColor: 'var(--color-brand-charcoal)', transition: 'all 0.3s', transform: mobileOpen ? 'rotate(45deg) translateY(7px)' : 'none' }} />
                <span style={{ display: 'block', width: 22, height: 2, backgroundColor: 'var(--color-brand-charcoal)', transition: 'all 0.3s', opacity: mobileOpen ? 0 : 1 }} />
                <span style={{ display: 'block', width: 22, height: 2, backgroundColor: 'var(--color-brand-charcoal)', transition: 'all 0.3s', transform: mobileOpen ? 'rotate(-45deg) translateY(-7px)' : 'none' }} />
              </button>
            </div>
          </div>
      ...
      >
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 6, backgroundColor: 'var(--color-brand-green)' }} />

        {/* Scaled logo for overlay (Upscaled by an additional 30% to Height 81px) */}
        <img src="/photo/heritage-logo.png" alt="Heritage Restoration" width={378} height={81} style={{ height: 81, width: 'auto', marginBottom: '1rem' }} />
