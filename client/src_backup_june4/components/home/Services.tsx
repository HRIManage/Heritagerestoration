    ...
    >
      <div className="page-container">
        ...
        <div className="max-w-2xl mb-16 md:mb-24">
          <span className="overline-label mb-3 text-brand-green">Our Expertise</span>
          <h2 className="font-serif text-3xl md:text-5xl font-medium text-brand-charcoal leading-tight mb-6">
            Architectural Recovery <br />&amp; Restoration Services
          </h2>
          ...
          <p className="font-sans text-brand-ink text-base md:text-lg font-light leading-relaxed">
            From emergency response to final walkthrough — full-spectrum property restoration managed with technical precision, empathy, and absolute care.
          </p>
        </div>
