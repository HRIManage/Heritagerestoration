    ...
    <footer className="bg-[#3F4143] text-white pt-20 pb-10 border-t border-white/5">
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-4 mb-8">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#8DBD42] transition-colors"
              >
                <Facebook size={18} />
              </a>
              <a
          ...
          <div>
            <h4 className="text-white font-black uppercase text-xs tracking-widest mb-6">
              Services
            </h4>
            <ul className="space-y-4">
              {serviceItems.map(item => (
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className="text-white/60 hover:text-[#8DBD42] text-sm font-bold transition-colors"
                  >
                    {item.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-4">
              {resourceItems.map(item => (
                <li key={item.label}>
                  <button
                    onClick={item.action}
                    className="text-white/60 hover:text-[#8DBD42] text-sm font-bold transition-colors cursor-pointer"
                  >
                    {item.label}
                  </button>
                </li>
            ...
            <ul className="space-y-6 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <a
                  ...
                  className="text-white/60 hover:text-[#8DBD42] font-bold transition-colors"
                >
                  +1(360)851-1407
                </a>
              </li>
