          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-8 leading-relaxed">
                Available 24/7 for emergency response. Contact us immediately
                for fire, water, or storm damage. We're here to help.
              </p>
            </FadeUp>
          </div>
        </section>
        ...
        <section className="py-20 md:py-32 bg-white">
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
              {[
                ...
                <FadeUp
                  key={idx}
                  delay={idx * 0.1}
                  className="bg-[#F5F7FA] rounded-lg p-8 text-center hover:shadow-lg transition-all duration-300"
                >
                  <div className="text-[#8DBD42] mb-4 flex justify-center">
                    {item.icon}
                  </div>
                  <h3 className="font-bold text-[#3F4143] mb-2 text-lg">
                    {item.title}
                  </h3>
                  <p className="text-[#3F4143] font-semibold mb-1">
                    {item.content}
                  </p>
            ...
            <FadeUp className="mb-20">
              <h2
                className="text-3xl md:text-4xl font-bold text-[#3F4143] mb-12 text-center"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Our Offices
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  <FadeUp
                    key={idx}
                    delay={idx * 0.1}
                    className="bg-[#F5F7FA] rounded-lg p-8 border border-gray-200 hover:border-[#8DBD42] transition-all duration-300"
                  >
                    <h3 className="font-bold text-[#3F4143] text-lg mb-4">
                      {office.name}
                    </h3>
                    <div className="space-y-3">
                      <div className="flex gap-3 items-start">
                        ...
                        />
                        <div>
                          <p className="text-[#3F4143] font-semibold">
                            {office.address}
                          </p>
                      ...
                      <div className="flex gap-3 items-center">
                        ...
                        <a
                          ...
                          className="text-[#3F4143] font-semibold hover:text-[#8DBD42] transition-colors"
                        >
                          {office.phone}
                        </a>
                      </div>
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-12 text-center">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl mx-auto">
                For non-emergency inquiries, fill out the form below and we'll
            ...
            <FadeUp className="max-w-2xl mx-auto">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    <label className="block text-[#3F4143] font-bold mb-2 text-sm">
                      Full Name *
                    </label>
                    <input
                      type="text"
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-12 text-center">
              ...
              <p className="text-lg text-[#3F4143]/70">
                We serve the entire Washington State region with rapid emergency
                response.
              </p>
            </FadeUp>
          ...
          <div className="max-w-[1280px] mx-auto px-6 text-center">
            <FadeUp>
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                For immediate emergency response, call our 24/7 hotline right
                away.
              </p>
              <a
                href="tel:+13608511407"
                className="inline-flex items-center justify-center gap-2 bg-white text-[#3F4143] font-bold px-8 py-4 rounded hover:bg-[#F5F7FA] transition-all duration-300 text-lg"
              >
