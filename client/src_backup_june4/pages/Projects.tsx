...
export default function Projects() {
  ...
  const categories = ["All", "Fire Restoration", "Water Restoration", "Storm Recovery"];
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="View our portfolio of fire, water, and storm damage restoration projects across Washington State." />
      </Helmet>
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-[#3F4143]/70 max-w-2xl mx-auto">
              Real results for real homeowners. See how we transform disaster into restoration.
            </p>
          </motion.div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    <div className="aspect-[4/5] rounded-lg overflow-hidden relative">
                      ...
                      <div className="absolute top-4 left-4 bg-black/60 text-white px-3 py-1 text-xs font-bold uppercase tracking-widest rounded">Before</div>
                    </div>
                  </div>
                  <div className="space-y-4 pt-12">
                    <div className="aspect-[4/5] rounded-lg overflow-hidden relative">
                      <img src={project.after} alt="After" className="w-full h-full object-cover" />
                      <div className="absolute top-4 left-4 bg-[#8DBD42] text-white px-3 py-1 text-xs font-bold uppercase tracking-widest rounded">After</div>
                    </div>
                  </div>
                </div>
                <div>
                  <div className="text-[#8DBD42] font-black uppercase text-sm tracking-[0.2em] mb-4">{project.type}</div>
                  <h2 className="text-4xl font-black text-[#3F4143] uppercase mb-6 leading-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>{project.title}</h2>
                  ...
                  <div className="grid grid-cols-2 gap-6 border-t border-gray-100 pt-8">
                    <div>
                      <div className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Duration</div>
                      <div className="text-[#3F4143] font-bold">Varies by scope</div>
                    </div>
                    <div>
                      <div className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Outcome</div>
                      <div className="text-[#3F4143] font-bold">Full Restoration</div>
                    </div>
                  </div>
                </div>
              </motion.div>
