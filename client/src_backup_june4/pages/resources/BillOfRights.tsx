  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Know your legal rights as a homeowner after property damage. You have the right to choose your own restoration contractor."
        />
      </Helmet>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-[#3F4143]/70 max-w-3xl mx-auto">
              In the wake of a disaster, it's easy to feel overwhelmed. We're
              here to ensure you know your rights and receive the full
              protection your insurance policy provides.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {rights.map((right, idx) => (
              ...
              >
                ...
                <h3
                  className="text-2xl font-black text-[#3F4143] uppercase mb-4"
                  style={{ fontFamily: "'Montserrat', sans-serif" }}
                >
                  {right.title}
                </h3>
                <p className="text-[#3F4143]/70 leading-relaxed text-lg">
                  {right.desc}
                </p>
              </motion.div>
            ))}
          ...
          <div className="mt-20 bg-[#3F4143] rounded-2xl p-12 text-center text-white">
            ...
            <p className="text-xl text-white/70 mb-10 max-w-2xl mx-auto">
              Don't let the insurance company dictate your recovery. Contact us
              today for a free consultation on your rights and your claim.
            </p>
            <a
              href="tel:+13608511407"
              className="inline-block bg-[#8DBD42] text-white px-10 py-5 rounded-sm font-black text-xl uppercase tracking-wider hover:bg-[#72a232] transition-colors"
            >
              Call (360) 851-1407
            </a>
          </div>
