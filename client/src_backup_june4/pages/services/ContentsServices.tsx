  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional contents pack-out, inventory, cleaning, and storage services. Digital tracking and climate-controlled vault storage."
        />
        <meta
          property="og:title"
        ...
        <meta
          ...
          content="Professional contents services with digital inventory tracking and secure vault storage."
        />
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-8 leading-relaxed">
                When disaster strikes, your personal belongings need
                professional care. We provide comprehensive pack-out, inventory,
                cleaning, and secure storage services to protect your valuables.
              </p>
              <a
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-16">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl">
                From careful packing to secure storage and professional
                cleaning, we handle your belongings with the care they deserve.
              </p>
            </FadeUp>
              ...
              {[
                {
                  ...
                  desc: "Evaluate all contents and determine which items require cleaning or specialized care.",
                },
                {
                  step: "2",
                  title: "Condition Documentation",
                  desc: "Photograph each item and document pre-existing condition for insurance purposes.",
                },
                {
                  step: "3",
                  title: "Professional Pack-Out",
                  desc: "Carefully pack all items using protective materials and secure containers.",
                },
                {
                  step: "4",
                  title: "Digital Inventory",
                  desc: "Create detailed inventory with photos, descriptions, and unique barcode tracking.",
                },
                {
                  step: "5",
                  title: "Specialized Cleaning",
                  desc: "Professional restoration cleaning for soot, smoke, water damage, and odor removal.",
                },
                {
                  step: "6",
                  title: "Secure Storage & Return",
                  desc: "Climate-controlled vault storage with 24/7 monitoring and organized return to your home.",
                },
              ].map((item, idx) => (
                <FadeUp
                  key={idx}
        ...
        <section className="py-20 md:py-32 bg-[#F5F7FA]">
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-12 text-center">
              <h2
                className="text-3xl md:text-4xl font-bold text-[#3F4143] mb-4"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <FadeUp
                  key={idx}
                  delay={idx * 0.05}
                  className="bg-white rounded-lg p-6 border border-gray-200 hover:border-[#8DBD42] transition-all duration-300"
                >
                  <p className="text-[#3F4143] font-semibold text-center">
                    {item}
                  </p>
                </FadeUp>
              ))}
          ...
          <div className="max-w-[1280px] mx-auto px-6 text-center">
            <FadeUp>
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Let us handle your contents with professional care and secure
                storage while your property is being restored.
              </p>
