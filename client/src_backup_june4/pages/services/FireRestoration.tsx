  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional fire damage restoration services in Washington. Emergency response within 45 minutes. Full structural reconstruction and smoke mitigation."
        />
        <meta
          property="og:title"
        ...
        <meta
          ...
          content="Professional fire damage restoration services in Washington. Emergency response within 45 minutes."
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Professional fire damage restoration and reconstruction services",
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="max-w-2xl">
              ...
              <p className="text-lg text-white/90 mb-8 leading-relaxed">
                ...
                responds within 45 minutes to secure your property, mitigate
                damage, and guide you through complete restoration to modern
                standards.
              </p>
              <a
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-16">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl">
                From emergency board-up to complete structural reconstruction,
                we handle every aspect of fire damage restoration with precision
                and care.
              </p>
            </FadeUp>
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-16 text-center">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl mx-auto">
                A proven methodology that minimizes disruption and maximizes
                recovery.
              </p>
            </FadeUp>
            ...
            <div className="space-y-6">
              {[
                {
                  step: "1",
                  title: "Emergency Response (45 min)",
          ...
          <div className="max-w-[1280px] mx-auto px-6 text-center">
            <FadeUp>
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Contact us immediately for emergency response, free assessment,
                and insurance consultation.
              </p>
