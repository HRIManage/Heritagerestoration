...
import { CloudLightning, Wind, Hammer, CheckCircle, Phone, Mail } from "lucide-react";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Emergency storm damage recovery and wind damage restoration. Roof tarping, tree removal, and structural repair in Washington." />
        <meta property="og:title" content="Storm Damage Recovery | Heritage Restoration" />
        <meta property="og:description" content="Professional storm damage recovery with emergency roof tarping and structural repairs." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Professional storm damage recovery and wind damage restoration",
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-16">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl">
                From emergency roof tarping to complete structural reconstruction, we restore your property quickly and professionally.
              </p>
            </FadeUp>
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-16 text-center">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl mx-auto">
                Systematic approach to emergency response and complete restoration.
              </p>
            </FadeUp>

            <div className="space-y-6">
              {[
                { step: "1", title: "Emergency Dispatch", desc: "Immediate response to secure your property and assess damage extent." },
                { step: "2", title: "Roof Tarping & Board-Ups", desc: "Emergency tarping and boarding to prevent water intrusion and further damage." },
                { step: "3", title: "Debris Removal", desc: "Professional cleanup of fallen trees, branches, and storm debris." },
                { step: "4", title: "Damage Documentation", desc: "Detailed photos and assessment for insurance claims and scope of work." },
                { step: "5", title: "Structural Repair", desc: "Complete repair or replacement of roofing, siding, windows, and framing." },
                { step: "6", title: "Final Inspection", desc: "Building code compliance verification and final walkthrough." }
              ].map((item, idx) => (
          ...
          <div className="max-w-[1280px] mx-auto px-6 text-center">
            <FadeUp>
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Call immediately for emergency tarping, debris removal, and storm damage restoration.
              </p>
