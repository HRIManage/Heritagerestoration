...
import { Droplets, Zap, Thermometer, CheckCircle, Phone, Mail } from "lucide-react";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Emergency water damage restoration and dryout services. 24/7 extraction, dehumidification, and mold prevention in Washington." />
        <meta property="og:title" content="Water Damage Restoration | Heritage Restoration" />
        <meta property="og:description" content="24/7 water extraction and professional drying services to prevent mold and structural damage." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Professional water damage restoration and drying services",
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-16">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl">
                From emergency extraction to complete drywall and flooring restoration, we prevent mold and restore your property to pre-loss condition.
              </p>
            </FadeUp>
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <FadeUp className="mb-16 text-center">
              ...
              <p className="text-lg text-[#3F4143]/70 max-w-2xl mx-auto">
                Rapid response and systematic drying to prevent mold and structural damage.
              </p>
            </FadeUp>

            <div className="space-y-6">
              {[
                { step: "1", title: "Emergency Assessment", desc: "Immediate evaluation of water source, extent of damage, and contamination level." },
                { step: "2", title: "Water Extraction", desc: "High-capacity pumps and vacuums remove all standing water within the first few hours." },
                { step: "3", title: "Moisture Detection", desc: "Thermal imaging and moisture meters identify hidden water in walls, floors, and cavities." },
                { step: "4", title: "Equipment Deployment", desc: "Industrial dehumidifiers, air movers, and HEPA filters deployed throughout the property." },
                { step: "5", title: "Monitoring & Adjustment", desc: "Daily moisture readings and equipment adjustments ensure optimal drying conditions." },
                { step: "6", title: "Restoration & Rebuild", desc: "Damaged materials replaced with new drywall, flooring, and finishes to pre-loss condition." }
              ].map((item, idx) => (
          ...
          <div className="max-w-[1280px] mx-auto px-6 text-center">
            <FadeUp>
              ...
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                Call immediately for 24/7 water extraction and emergency mitigation services.
              </p>
